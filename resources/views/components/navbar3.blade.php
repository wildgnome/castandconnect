<!--
  ...
  ```
-->
<div class="nav-bar fixed top-0 w-full transition-all duration-500 z-50">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                {{-- <a href="#hero" class="rounded-md px-3 py-2 text-sm font-medium text-white bg-gray-900" aria-current="page">Home</a> --}}
                <a href="#hero" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Home</a>

                <a href="#what-we-do" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">What we do</a>
                <a href="#our-resources" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Our resources</a>
                <a href="#customer-reviews" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Customer reviews</a>
